...
| # | ファイル | チケット | 状態 |
|---|---|---|---|
| 01 | [01-foundation.md](./01-foundation.md) | プロジェクト基盤（Supabase + OAuth + allowlist + デザイン基盤） | 未着手 |
...
| 06 | [06-manual-region.md](./06-manual-region.md) | 「今回だけ範囲指定」 | 未着手 |
| 07 | [07-worker-tts.md](./07-worker-tts.md) | Worker: tts + 音声再生 | 未着手 |
